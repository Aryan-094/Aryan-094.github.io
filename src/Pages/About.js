      ...
      <div className="min-h-[90vh]">
        ...
        <div className="container mx-auto px-4 py-10">
          ...
          <p className="text-lg mb-10 text-center">
            We are dedicated to providing you with the most accurate and up-to-date
            food price comparisons across various delivery platforms. Our mission
            is to make your food ordering experience seamless and cost-effective.
          </p>
